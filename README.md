...
This plugin offers support for the [npm](https://www.npmjs.com/) dependency manager and the [Yarn](https://yarnpkg.com/) dependency manager. You can find the agjCalendar package online on [npmjs.com](https://www.npmjs.com/package/agjcalendar).
